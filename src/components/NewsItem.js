    ...
    return (
        <div className="card max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative">
            ...
            <div className="p-5 flex h-[calc(100% - 30vh)] justify-between flex-col">
                <a href={url}>
                    <h5 className="title mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">{title}...</h5>
                </a>
                <div className="desc mb-2 font-normal text-gray-700 dark:text-gray-400 overflow-hidden">{description}..</div>
